...
With that fixed and real time still left, built three more real, deployed features against the still-open cut list, each confirmed live in a real browser before moving to the next:
